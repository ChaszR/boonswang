...
function optionsframework_add_admin() {
		...
		$mctitle = "MC Studios Panel";
		$of_page = add_menu_page( $mctitle, THEMENAME.'', 'edit_theme_options', 'optionsframework', 'optionsframework_options_page');
...
function optionsframework_options_page(){
	...
	*/	
	...
	include_once( ADMIN_PATH . 'function-front-end.php' );
...
function of_load_only() 
{
	...
	wp_enqueue_script('merged_scripts', ADMIN_DIR . 'assets/js/merged-scripts.js', 'jquery');
	wp_enqueue_script('mcfonts', ADMIN_DIR . 'assets/js/mcfonts.js', 'jquery');
	wp_enqueue_script('smof', ADMIN_DIR .'assets/js/mcframework.js', array( 'jquery' ));
}
...
function of_admin_head() { ?>
	...
	$('.colorSelector').each(function(){
		...
		var ppP = jQuery(this).parent().parent().parent().attr('id');		
		$(this).ColorPicker({
				...
				onChange: function (hsb, hex, rgb) {
					...
					$('#'+ppP+' #font-refresh').css("color","#"+ hex);
					Cufon.refresh();
