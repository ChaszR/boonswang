...
class AttachmentsMigrate extends Attachments
{
                    ...
                    <tbody>
                        <tr valign="top">
                            ...
                            <td>
                                ...
                                <p class="description">The instance name you would like to use in the migration. Required.</p>
                            </td>
                        </tr>
                        <tr valign="top">
                            <th scope="row">
    ...
    function init_migration()
    {
        ...
        ?>
            ...
            <p>The migration has completed. <strong>Migrated: <?php echo $total; ?></strong>.</p>
        <?php else : ?>
            <h3>Migration has already Run!</h3>
            <p>The migration has already been run. The migration process has not been repeated.</p>
        <?php endif;
