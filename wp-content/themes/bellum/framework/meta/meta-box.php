...
if ( ! defined( 'RWMB_URL' ) )
	...
	//define( 'RWMB_URL', trailingslashit( get_stylesheet_directory_uri() . '/framework/functions/meta/' ) );
	define( 'RWMB_URL', trailingslashit( META_DIR ) );
...
if ( ! defined( 'RWMB_DIR' ) )
	...
	//define( 'RWMB_DIR', trailingslashit( get_stylesheet_directory() . '/framework/functions/meta/' ) );
	
	define( 'RWMB_DIR', trailingslashit( META_PATH ) );
