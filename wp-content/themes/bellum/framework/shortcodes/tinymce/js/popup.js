...
jQuery(document).ready(function($) {
    var mcstudios = {
    	...
    	resizeTB: function()
    	{
            ...
            tbWindow.css({
                height: mcPopup.outerHeight() + 50,
                width: mcPopup.outerWidth(),
                marginLeft: -(mcPopup.outerWidth()/2)
            });
    	...
    	load: function()
    	{
    		...
    		// resize TB
    		mcstudios.resizeTB();
    		$(window).resize(function() { mcstudios.resizeTB() });
    ...
    // run
    $('#zilla-popup').livequery( function() { mcstudios.load(); } );
});